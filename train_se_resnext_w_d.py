...
def main():
    ...
    if args.data_type == "cifar10":
        ...
        else [64, 64, 128, 256, 512], ratio_list=ratio_list, num_class=args.num_classes, num_group=args.num_group,
                         data_type="imagenet", drop_out=args.drop_out, bottle_neck=True
    ...
    train = mx.io.ImageRecordIter(
        ...
        else os.path.join(args.data_dir, "trn"),
        label_width=1,
        data_name='data',
    ...
    val = mx.io.ImageRecordIter(
        ...
        os.path.join(args.data_dir, "avitonet4k_val.rec"),
        label_width=1,
        data_name='data',
        label_name='softmax_label',
        batch_size=args.batch_size,
